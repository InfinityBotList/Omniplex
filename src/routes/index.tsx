...
function HomePage() {
  return (
    <PageLayout>
      ...
      <Suspense fallback={<LoadingSkeleton title="Featured Bots" count={6} variant="featured" />}>
        <FeaturedBotsSection />
      </Suspense>

      {/* Popular Packs Section */}
      <Suspense fallback={<LoadingSkeleton title="Bot Packs" count={3} variant="featured" />}>
        <PopularPacksSection />
      </Suspense>
