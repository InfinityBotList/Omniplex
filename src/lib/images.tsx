 ...
 */
export function getBotAvatarUrl(botId: string, options: ImageOptions = {}): string {
 ...
 */
export function getBotBannerUrl(botId: string, options: ImageOptions = {}): string {
 ...
 */
export function getServerIconUrl(serverId: string, options: ImageOptions = {}): string {
  const { size = 128, format = 'webp' } = options
 ...
 */
export function getServerBannerUrl(serverId: string, options: ImageOptions = {}): string {
  const { format = 'webp' } = options
 ...
 */
export function getServerSplashUrl(serverId: string, options: ImageOptions = {}): string {
  const { format = 'webp' } = options
 ...
 */
export function getPackIconUrl(packId: string, options: ImageOptions = {}): string {
  const { size = 128, format = 'webp' } = options
 ...
 */
export function getPackBannerUrl(packId: string, options: ImageOptions = {}): string {
  const { format = 'webp' } = options
 ...
 */
export function BotAvatarPlaceholder({ className = '', size = 64 }: PlaceholderProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      {/* Bot antenna */}
      <rect x="30" y="4" width="4" height="8" rx="2" className="fill-muted-foreground/30" />
 ...
 */
export function ServerIconPlaceholder({ className = '', size = 64 }: PlaceholderProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        ...
        rx="4"
      />
      <rect x="24" y="24" width="16" height="4" rx="2" className="fill-muted-foreground/40" />
      <rect x="24" y="32" width="12" height="4" rx="2" className="fill-muted-foreground/30" />
      <rect x="24" y="40" width="8" height="4" rx="2" className="fill-muted-foreground/20" />
    </svg>
  )
}
 ...
 */
export function UserAvatarPlaceholder({ className = '', size = 64 }: PlaceholderProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 */
export function PackIconPlaceholder({ className = '', size = 64 }: PlaceholderProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="14" y="22" width="36" height="28" rx="4" className="fill-muted-foreground/20" />
      <rect x="18" y="18" width="28" height="24" rx="3" className="fill-muted-foreground/30" />
      <rect x="22" y="14" width="20" height="20" rx="2" className="fill-muted-foreground/40" />
    ...
    >
      ...
      <defs>
        <linearGradient id="bannerGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" className="[stop-color:oklch(var(--brand-500)/0.3)]" />
          <stop offset="50%" className="[stop-color:oklch(var(--accent-500)/0.2)]" />
          <stop offset="100%" className="[stop-color:oklch(var(--brand-600)/0.3)]" />
        </linearGradient>
      </defs>
 ...
 */
export function BotAvatar({ botId, name = 'Bot', size = 64, className = '' }: BotAvatarProps) {
  ...
  return (
    <ImageWithFallback
      ...
      fallback={<BotAvatarPlaceholder size={size} className={`${sizeClass} ${className}`} />}
    />
  )
}
 ...
 */
export function ServerIcon({ serverId, name = 'Server', size = 64, className = '' }: ServerIconProps) {
  const sizeClass = getSizeClass(size)
  ...
  return (
    <ImageWithFallback
      ...
      fallback={<ServerIconPlaceholder size={size} className={`${sizeClass} ${className}`} />}
    />
  )
}
...
export function UserAvatar({ 
  ...
  return (
    <ImageWithFallback
      ...
      fallback={<UserAvatarPlaceholder size={size} className={`${sizeClass} ${className}`} />}
    />
  )
}
 ...
 */
export function PackIcon({ packId, name = 'Pack', size = 64, className = '' }: PackIconComponentProps) {
  const sizeClass = getSizeClass(size)
  ...
  return (
    <ImageWithFallback
      ...
      fallback={<PackIconPlaceholder size={size} className={`${sizeClass} ${className}`} />}
    />
  )
}
