	...
	return (
		<div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
			...
			<div
				...
				style={{
					background:
						"radial-gradient(circle, oklch(0.6 0.2 var(--accent-hue) / 0.5) 0%, transparent 70%)",
					filter: "blur(80px)",
			...
			<div
				...
				style={{
					background:
						"radial-gradient(circle, oklch(0.65 0.18 calc(var(--accent-hue) + 40) / 0.5) 0%, transparent 70%)",
					filter: "blur(80px)",
			...
			<div
				...
				style={{
					background:
						"radial-gradient(circle, oklch(0.55 0.22 calc(var(--accent-hue) - 30) / 0.45) 0%, transparent 70%)",
					filter: "blur(100px)",
			...
			<div
				...
				style={{
					background:
						"linear-gradient(to top, oklch(0.1 0.02 var(--accent-hue) / 0.5) 0%, transparent 100%)",
				}}
			/>
		...
		<div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
          ...
          `,
			...
			<div
				...
				style={{
					background:
						"linear-gradient(to top, oklch(0.1 0.02 var(--accent-hue) / 0.6) 0%, transparent 100%)",
				}}
			/>
		</div>
	);
	...
	return (
		<div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
			...
			<div
				...
				style={{
					background:
						"radial-gradient(ellipse at center top, transparent 0%, oklch(0.12 0.01 var(--accent-hue) / 0.3) 100%)",
				}}
			/>
			...
			<div
				...
				style={{
					background:
						"radial-gradient(circle, oklch(0.6 0.2 var(--accent-hue) / 0.4) 0%, transparent 70%)",
					filter: "blur(80px)",
		...
		<div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
          ...
          `,
			...
			<div
				...
				style={{
					background:
						"radial-gradient(ellipse at center top, oklch(0.6 0.2 var(--accent-hue) / 0.35) 0%, transparent 70%)",
			...
			<div
				...
				style={{
					background:
						"linear-gradient(to top, oklch(0.08 0.02 var(--accent-hue) / 0.7) 0%, transparent 100%)",
				}}
			/>
		</div>
	);
		...
		<div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
          ...
          `,
			...
			<div
				...
				style={{
					background:
						"radial-gradient(circle, oklch(0.6 0.2 var(--accent-hue) / 0.3) 0%, transparent 70%)",
					filter: "blur(60px)",
			...
			<div
				...
				style={{
					background:
						"radial-gradient(circle, oklch(0.65 0.18 calc(var(--accent-hue) + 40) / 0.25) 0%, transparent 70%)",
					filter: "blur(50px)",
					animation: "bg-glow 6s ease-in-out infinite",
					animationDelay: "-3s",
				}}
