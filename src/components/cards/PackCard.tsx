			...
			>
				<div className="relative">
					{iconUrl ? (
						...
						<PackIconPlaceholder
							size={40}
							className="ring-2 ring-border rounded-lg"
						/>
					)}
					...
					<div className="absolute -top-8 left-5">
						<div className="relative">
							{iconUrl ? (
								...
								<PackIconPlaceholder
									size={64}
									className="ring-4 ring-[var(--glass-bg)] shadow-xl rounded-xl"
								/>
							)}
			...
			<div className="p-4 relative">
				...
				<div className="absolute -top-5 left-4">
					{iconUrl ? (
						...
						<PackIconPlaceholder
							size={40}
							className="ring-2 ring-[var(--glass-bg)] shadow-lg rounded-lg"
						/>
					)}
				</div>
