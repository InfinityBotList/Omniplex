    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground truncate">{bot.short || "No description"}</p>
        </div>
      </Link>
    );
  }
    ...
    >
      ...
      <div className="p-4 relative">
        ...
        <div className="flex justify-end gap-1 mb-4">
          {isCertified && (
            <span className="w-5 h-5 bg-brand-500/20 rounded-full flex items-center justify-center" title="Certified">
          ...
          {isPremium && (
            <span className="w-5 h-5 bg-brand-500/20 rounded-full flex items-center justify-center" title="Premium">
              <svg className="w-3 h-3 text-brand-400" fill="currentColor" viewBox="0 0 20 20">
